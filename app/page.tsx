  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-slate-900 text-white">
      ...
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-bold">Abhinav Parasar</h1>
        <p className="text-slate-400 mb-6">SAP Tech Dev</p>
        
        {/* Action Buttons */}
        <div className="flex flex-col gap-3">
          <a href="https://github.com/Abhinavparasar" target="_blank" className="w-full py-3 px-4 bg-emerald-600 rounded-lg border border-emerald-500 hover:bg-emerald-500 transition">
            GitHub
          </a>
          <a href="https://www.linkedin.com/feed/" target="_blank" className="w-full py-3 px-4 bg-yellow-400 rounded-lg border border-yellow-300 hover:bg-yellow-300 transition text-gray-900">
            LinkedIn
          </a>

          <form action={submitToCap}>
            <input type="hidden" name="communityId" value="Abhinav-Parasar_0312" />
